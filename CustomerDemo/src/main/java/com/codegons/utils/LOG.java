...
public enum LOG {
	INPUT_PARAM("parameter Name "), DATA_LOAD_COMPLETED(" Feed file Load completed Successfully ( Took : "),
	FEED_FILE_RECORD_COUNT(" Total Feed Record Count :  "), API_TRANSACTION_ID("API TransactionId"),
	FETCH_ZIP_CODE("Processing Zip Code Details with zipcode : "),
